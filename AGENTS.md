...
- `global-skills/` — Canonical source for user-level skills at `~/.claude/skills/` (edit here first, then `scripts/sync-global-skills.sh link`; `--check` guards drift)
