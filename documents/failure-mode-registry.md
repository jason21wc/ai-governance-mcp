...
entries:
  ...
  - id: FM-HYGIENE-KEEP-REF-IDENTITY
    ...
    source: "BACKLOG #375"
  - id: FM-DOC-POINTER-OWNER-SCOPE
    description: "An absent pointer-source document exempts only that owner's expected pointers. Every surviving owner must still declare its expected pointers, including pointers shared with another document. Ownership must be independent of current discovery so deletion cannot erase its own obligation."
    must_cover: false
    scope: project
    introduced: "2026-09-08"
    source: "BACKLOG #340"
