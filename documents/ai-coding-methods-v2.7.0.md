...
| `ProjectStatus` | Index statistics | `project_id`, `total_files`, `total_chunks`, `index_mode`, `last_updated`, `index_size_bytes`, `embedding_model` |
...
**Document connector:**
- Markdown: section-based chunking by heading boundaries (`#`, `##`, `###`, etc.) — each section becomes one chunk
- Plain text: ~30-line target chunks, splitting at paragraph boundaries (blank lines)
...
**Authority:** This document implements ai-coding-domain-principles.md (v2.3.0). Methods cannot contradict principles.
