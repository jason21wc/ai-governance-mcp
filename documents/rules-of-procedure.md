...
| Stare Decisis | considered-and-rejected → RoP §9.8.1 Q7 FAIL exemplars (lines 2783-2785) | Pre-v5.0.0 "Case Law" label imported binding-precedent semantics; framework explicitly stripped override authority. Renamed to "Secondary Authority" v5.0.0. |
