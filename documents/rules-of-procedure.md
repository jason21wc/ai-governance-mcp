...
- **Research-anchored operational thresholds** — runtime/turn/iteration values derived from empirical research (e.g., Agent Drift onset 35 min per arxiv 2601.04170, circuit-breaker windows, debounce intervals, drift-detection windows) used as process gates rather than effort estimates the AI is producing. These are externally-anchored operational tunables, not AI-generated calibration claims. Example: title-10-cfr §5.1.8 Mid-Execution Checkpoint Protocol's ">30 min runtime" trigger is a research-anchored process gate (Agent Drift research), not a §7.12 violation.
