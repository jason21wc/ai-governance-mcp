...
3. **Meta-only index** — the search index is **rebuilt from `documents/`** at
   install/CI time (constitution only). It is a build artifact and is **not
...
<!-- Do not edit by hand. Written by scripts/stamp_provenance.py during
     scripts/build-public-release.sh. Verify by regenerating and diffing;
     never by comparing publish dates (rules-of-procedure Part 5.3 §5.3.2). -->
...
- **source-commit:** `24761cbaf5c02e5d55048352046f1ce45abe146d`
