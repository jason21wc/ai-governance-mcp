...
|--------|------------|---------|----------|
| **Constitution** | 22 | 200 | Universal AI behavior, safety, quality |
| **AI Coding** | 12 | 220 | Software development, testing, deployment |
...
> **Note:** Windsurf has a 100 tool limit across all MCPs. The governance server provides 13 tools.
...
Full test suite covering governance (~90% coverage) and context engine (~65%). Run `pytest --collect-only -q | tail -1` for current count.
