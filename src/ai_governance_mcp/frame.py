...
The FRAME string is the per-turn reasoning AND answer-shape re-anchor injected by the Claude Code
...
FRAME = (
    ...
    "ANSWER SHAPE: answer first, ~200 words unless depth/doc/code asked "
    "(bluf-pyramid-briefing) | close with the ask (close-with-the-ask) | "
    "ask in prose, not a menu (freeform-dialogue)."
)
