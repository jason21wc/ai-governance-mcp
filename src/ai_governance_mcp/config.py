...
def _default_domains() -> list[DomainConfig]:
    ...
    return [
        DomainConfig(
            ...
            methods_file="ai-governance-methods-v3.17.0.md",
            description=(
        ...
        DomainConfig(
            ...
            principles_file="ai-coding-domain-principles-v2.7.0.md",
        ...
        DomainConfig(
            ...
            principles_file="multi-agent-domain-principles-v2.7.0.md",
        ...
        DomainConfig(
            ...
            principles_file="storytelling-domain-principles-v1.4.0.md",
        ...
        DomainConfig(
            ...
            principles_file="multimodal-rag-domain-principles-v2.4.0.md",
