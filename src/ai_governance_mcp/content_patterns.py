...
defeat homoglyphs (see ``normalize_text_for_security``), and BACKLOG #360 tracks its
measured efficacy, which is poor. Treat a clean result as "nothing obvious", never as
"safe".
"""
