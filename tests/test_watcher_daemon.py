...
class TestGetBasePath:
    ...
    @pytest.mark.real_home  # DEFAULT_BASE_PATH is a module-level Path.home()
    # constant, resolved at IMPORT time — no fixture, monkeypatch or env change
    # made afterwards can move it. Six such constants exist (embedding_ipc,
    # semantic_rank, service, watcher_daemon). This is a TEST-ISOLATION limit,
    # not a production defect: capturing HOME at process start is correct
    # behaviour, and HOME only changes mid-process under test.
